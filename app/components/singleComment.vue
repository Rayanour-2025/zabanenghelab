            ...
            <div class="flex gap-x-5">
                <div
                    ...
                    <div class="flex items-center ml-2">
                        ...
                        <like width="30" :color="commentData?.user_like_status == 'liked' ? '#f00' : '#2B2B2B' " @click="reaction('like', commentData.id); commentData.user_like_status = 'liked'" height="30" />
                    </div>
                    <div @click="reaction('dislike', commentData.id);commentData.user_like_status = 'disliked'">
